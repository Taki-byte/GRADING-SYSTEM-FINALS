...
$sql = "SELECT id, user_id, surname, first_name, middle_name, role FROM users WHERE TRIM(LOWER(role)) = 'teacher'";
...
<head>
    ...
    <style>
        ...
        .update-btn {
            background-color: #28a745; color: white; border: none; padding: 6px 16px;
